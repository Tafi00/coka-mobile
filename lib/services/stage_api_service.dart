...
class StageApiService {
  ...
  final Dio _dio = Dio(
    BaseOptions(
      baseUrl: 'https://api.coka.ai',      // 👈 base URL cho stage list API
  ...
  Future<HiddenStagesResponse> getHiddenStagesAndGroups(
      String orgId, String workspaceId) async {
    try {
      final response = await _appDio.get(  // Sử dụng _appDio với base URL app.coka.ai
