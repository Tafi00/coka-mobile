...
class _TiktokConfigPageState extends ConsumerState<TiktokConfigPage> {
  ...
  Future<void> _fetchTiktokAccounts() async {
    ...
    try {
      ...
      final response = await leadRepository.getLeadList(
  ...
  Future<void> _openTiktokAuthWindow() async {
    try {
      ...
      final url = Uri.parse(
        "https://api.coka.ai/api/v1/integration/tiktok/auth/lead?accessToken=$accessToken&organizationId=${widget.organizationId}&workspaceId=${widget.workspaceId}"
      );
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          ...mappingData.asMap().entries.map((entry) => 
                            _buildMappingRow(entry.key)
                          ),
