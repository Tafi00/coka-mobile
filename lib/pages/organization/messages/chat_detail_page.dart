...
class _ChatDetailPageState extends ConsumerState<ChatDetailPage> {
  ...
  Future<void> _handleFileSelected(String filePath, {required bool isImage, required String fileName}) async {
...
class _MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(
      builder: (context, ref, child) {
        ...
        final isFromPage = message.from == '124662217400086'; // ID của page
        
        // Determine error state
        final hasError = chatState.messageErrors.containsKey(message.localId ?? message.id);
        final errorMessage = hasError ? chatState.messageErrors[message.localId ?? message.id] : null;
                          ...
                          children: [
                            Flexible(
                              child: Container(
                                ...
                                padding: (message.attachments?.isNotEmpty == true || message.fileAttachment != null) &&
                              ...
                              Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text('Lỗi: ${errorMessage ?? 'Không thể gửi tin nhắn'}'),
  ...
  Widget _buildFileWidget(String fileName, VoidCallback onTap, BuildContext context, {bool isLocal = false}) {
    return Container(
      margin: const EdgeInsets.only(bottom: 8),
