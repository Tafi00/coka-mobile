...
class ChatHelpers {
  ...
  static MessagePosition getMessagePosition(List messages, int index, String currentPersonId) {
    ...
    if (messages.length == 1) {
      ...
      if (isFromCurrentPerson != prevIsFromCurrentPerson && isFromCurrentPerson == nextIsFromCurrentPerson) {
        return MessagePosition.firstInReply;
      } else if (isFromCurrentPerson == prevIsFromCurrentPerson && isFromCurrentPerson != nextIsFromCurrentPerson) {
